            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form class="form-horizontal form-label-left input_mask" >
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input class="form-control" id="inputSuccess3" placeholder="Abogado" type="text" name="abogado" readonly="readonly" value="<?=$_SESSION['DatosUsuario'][0]->Nombre.' '.$_SESSION['DatosUsuario'][0]->Apellido1.' '.$_SESSION['DatosUsuario'][0]->Apellido2?>" >
